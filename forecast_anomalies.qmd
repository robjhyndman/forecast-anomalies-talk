...
\only<3>{\begin{textblock}{10.2}(0.3,6.2)
...
\only<2>{\begin{textblock}{9.5}(2.2,3.2)\fontsize{12}{13}\sf
\begin{alertblock}{}
Forecast distribution:\hfill $N(4261, 369^2)$\\
Actual:\hfill $y_t = 24616$\\
Anomaly score:\hfill $s_t = -\log f(y_t | y_1,\dots,y_{t-1}) = 1529$
Probability of anomaly:\hfill $P(S > s_t | S > q_{0.95}) = 0.0009$
\end{alertblock}
\end{textblock}
}
